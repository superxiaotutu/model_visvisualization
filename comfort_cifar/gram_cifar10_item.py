...
# a_list,b_list,c_list=[8,9],[5,6],[1,2]
...
# a_list,b_list,c_list=[4,5],[2,1],[1]
# a_list,b_list,c_list=[18,19],[3,4],[1]
# a_list,b_list,c_list=[17,16],[2,1],[1]
# a_list,b_list,c_list=[13,12],[10,8],[1]
# a_list,b_list,c_list=[14,15],[3,4],[1]
# a_list,b_list,c_list=[13,10],[3,4],[1]
# a_list,b_list,c_list=[10,8],[4,1],[1]
# a_list,b_list,c_list=[7,5],[2,3],[1]

a_list,b_list,c_list=[8,5],[3,1],[1]
        ...
        for ci, c in enumerate(c_list):
            ...
            for i in range(50000):
                ...
                _, adv_acc, adv_summery = sess.run([train_op, accuracy, summary_op],
                                                   feed_dict={X: batch[0], X_adv: adv_sample_N1, Y: batch[1],
                                                              keep_prop: 0.5})
                ...
                if 1 % 100 == 0:
                    ...
                    test_acc, test_summ = sess.run([accuracy, summary_op],
                                                   feed_dict={X: testbatch[0], Y: batch[1], keep_prop: 1.0})
