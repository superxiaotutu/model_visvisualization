...
def save():
    ...
    saver.save(sess, "model_gramloss" + str(a) + '_' + str(b) + '_' + str(c) + "/model.ckpt")
...
with tf.name_scope("total_loss"):
    total_loss = a * classification_loss + c * grad_cam_loss
...
result_file = 'result_gramloss' + str(a) + '_' + str(b) + '_' + str(c) + '.txt'
...
f_w.write(str(a) + "result_gramloss " + str(b) +" "+str(c)+ " ")
