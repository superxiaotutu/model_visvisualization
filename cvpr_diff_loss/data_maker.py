...
def load_json(img_id):
    cat_id_list = set()
    img_dir = "H:\download/ImageNet2012/coco2017/train2017/"
    return_pack = {}
...
# writer = tf.python_io.TFRecordWriter('/run/media/kirin/DOC/ImageNet2012/train_for_A.tfrecords')
...
for img in img_ids:
    try:
        ...
        #     feature = {'label': _int64_feature(data[0]), 'A_img': _bytes_feature(data[1])}
