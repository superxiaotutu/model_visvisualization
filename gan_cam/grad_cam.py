...
saver.restore(sess, "/home/kirin/PycharmProjects/CVPR_attantion_map/grand_cam/inception_v3.ckpt")
...
plt.subplot(1, 3, 2)
plt.imshow(rar_gard_cam)

plt.subplot(1, 3, 3)
plt.imshow(adv_gard_cam)
